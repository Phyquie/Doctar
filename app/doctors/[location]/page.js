...
export default function DoctorsByLocationPage() {
  ...
  // Format location for display and extract city name
  ...
  const extractCityName = (locationSlug) => {
    ...
    // For unclear patterns, return the whole slug
    return locationSlug;
  };
  ...
  const fetchDoctors = useCallback(async (page = 1, filters = {}, isInitialLoad = false) => {
    try {
      ...
      const params = new URLSearchParams({
        ...
        location: searchCityName, // Filter by city name only
        ...filters
      });
  ...
  }, [pagination.limit, searchCityName]);
  ...
  }, [selectedSpecialization, searchTerm, priceRange, sortBy, fetchDoctors, initialLoad]);
    ...
    >
      ...
      <div className="bg-gradient-to-r from-[#5f4191] to-[#7c5aa3] p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg px-3 py-2">
            <div className="text-[#5f4191] text-lg font-bold">₹{doctor.consultationFee}</div>
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <span className=" text-[#5f4191] bg-opacity-10  px-3 py-1 rounded-full text-xs font-semibold bg-white">
        ...
        <div className="flex items-center space-x-2 mb-4 p-3 bg-gray-50 rounded-lg">
          ...
          <span className="text-gray-700 text-sm font-medium truncate">{doctor.clinicName}</span>
        </div>
              ...
              <div className="flex-1 mr-4">
                ...
                <div className="flex items-center space-x-6 mb-3">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-700 text-sm font-medium">{doctor.clinicName}</span>
                  </div>
                </div>
  ...
  return (
    <>
      <Head>
        <title>Doctors in {displayLocation} | Doctar</title>
        <meta name="description" content={`Find and book appointments with qualified doctors in ${displayLocation}. Browse ${pagination.total} verified healthcare professionals with ratings and reviews.`} />
        <meta name="keywords" content={`doctors ${displayLocation}, medical consultation ${displayLocation}, healthcare ${displayLocation}, book appointment ${displayLocation}`} />
        <meta property="og:title" content={`Doctors in ${displayLocation} | Doctar`} />
        <meta property="og:description" content={`Find and book appointments with qualified doctors in ${displayLocation}. Browse verified healthcare professionals.`} />
        <meta property="og:url" content={`https://doctar.in/doctors/${location}`} />
        <link rel="canonical" href={`https://doctar.in/doctors/${location}`} />
      </Head>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-6">
                Find and book appointments with qualified healthcare professionals in {displayLocation}
              </p>
              <div className="flex items-center justify-center space-x-6 text-sm text-gray-500">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-medium">{pagination.total} Doctors</span>
                </div>
                <div className="flex items-center space-x-2">
                  <svg className="w-5 h-5 text-[#5f4191]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
            ...
            <form onSubmit={handleSearch} className="mb-6">
              <div className="relative">
                <input
                  type="text"
                  placeholder={`Search doctors in ${displayLocation}...`}
                  value={searchTerm}
            ...
            <div className="flex flex-wrap items-center gap-4 mb-4">
              ...
              <div className="text-sm text-gray-500">
                {pagination.total} doctors found in {displayLocation}
              </div>
            </div>
          ...
          {doctors.length > 0 ? (
            ...
            <div className="bg-white rounded-xl shadow-sm p-12 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">No Doctors Found in {displayLocation}</h3>
              <p className="text-gray-600 mb-4">
                {searchTerm || selectedSpecialization 
                  ? `No doctors match your search criteria in ${displayLocation}. Try adjusting your filters.`
                  : `There are no doctors registered in ${displayLocation} yet.`
                }
              </p>
              {(searchTerm || selectedSpecialization) && (
                <button
