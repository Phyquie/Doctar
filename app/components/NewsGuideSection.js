  ...
  return (
    <div className="mt-6">
      <div className="flex justify-between items-center mt-[46px] ml-[30px] mr-[30px]">
        <h2 className="text-black text-2xl font-bold">News & Guide</h2>
        <Link 
          href="/news" 
          ...
          >
            <div className="relative flex-shrink-0">
              {newsItem.images && newsItem.images.length > 0 ? (
                ...
                <div className="w-full h-48 bg-gradient-to-br from-blue-400 to-blue-600 rounded-t-4xl flex items-center justify-center">
