...
// GET method - Fetch all blogs with pagination
...
export async function POST(request) {
  try {
    ...
    // Save the blog (slug will be auto-generated by pre-save middleware)
    const savedBlog = await newBlog.save();
    
    // Populate author information
    await savedBlog.populate('author', 'firstName lastName email specialization');
    
    // Log the admin action
    console.log(`Admin ${admin.email} created blog: ${savedBlog.heading} (ID: ${savedBlog._id})`);
