  ...
  useEffect(() => {
    ...
    const specializationsData = [
      ...
      },
      {
        ...
        icon: '/icons/general-physician.PNG',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredSpecializations.map((specialization) => (
              <Link
                ...
                className="group"
              >
                <div className={`bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 p-6 border-2 ${specialization.color} group-hover:scale-105`}>
                  <div className="flex flex-col items-center text-center">
                    ...
                    {/* Name */}
                    <h3 className="text-lg font-semibold mb-2 group-hover:text-[#5f4191] transition-colors">
                      {specialization.name}
                    </h3>
                    ...
                    {/* Arrow */}
                    <div className="flex items-center text-sm font-medium group-hover:text-[#5f4191] transition-colors">
