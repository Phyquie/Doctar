...
export default function SpecializationPage() {
  ...
  // Specializations mapping - URL slug to API value
  ...
  }, [pagination.limit, actualSpecialization]);
  ...
  }, [selectedLocation, searchTerm, priceRange, sortBy, fetchDoctors, initialLoad]);
  ...
  return (
    <>
      <Head>
        <title>{actualSpecialization} Doctors | Find {actualSpecialization} Specialists | Doctar</title>
        <meta name="description" content={`Find qualified ${actualSpecialization} doctors and specialists. Browse ${pagination.total} verified ${actualSpecialization} healthcare professionals with ratings and reviews.`} />
        <meta name="keywords" content={`${actualSpecialization} doctors, ${actualSpecialization} specialists, medical consultation, healthcare professionals`} />
        <meta property="og:title" content={`${actualSpecialization} Doctors | Doctar`} />
        <meta property="og:description" content={`Find qualified ${actualSpecialization} doctors and specialists. Browse verified healthcare professionals.`} />
        <meta property="og:url" content={`https://doctar.in/specialist/${speciality}`} />
        <link rel="canonical" href={`https://doctar.in/specialist/${speciality}`} />
      </Head>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <nav className="mb-6">
            <ol className="flex items-center space-x-2 text-sm text-gray-500">
              ...
              <li>/</li>
              <li className="text-gray-900">{actualSpecialization}</li>
            </ol>
          </nav>
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
            <div className="text-center">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">
                {actualSpecialization} Doctors
              </h1>
              <p className="text-xl text-gray-600 mb-6">
                Find qualified {actualSpecialization} specialists and healthcare professionals
              </p>
              <div className="flex items-center justify-center space-x-6 text-sm text-gray-500">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-medium">{actualSpecialization}</span>
                </div>
                <div className="flex items-center space-x-2">
                  <svg className="w-5 h-5 text-[#5f4191]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
            ...
            <form onSubmit={handleSearch} className="mb-6">
              <div className="relative">
                <input
                  type="text"
                  placeholder={`Search ${actualSpecialization} doctors...`}
                  value={searchTerm}
            ...
            <div className="flex flex-wrap items-center gap-4 mb-4">
              ...
              <div className="text-sm text-gray-500">
                {pagination.total} {actualSpecialization} doctors found
              </div>
            </div>
          ...
          {doctors.length > 0 ? (
            ...
            <div className="bg-white rounded-xl shadow-sm p-12 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">No {actualSpecialization} Doctors Found</h3>
              <p className="text-gray-600 mb-4">
                {searchTerm || selectedLocation 
                  ? `No ${actualSpecialization} doctors match your search criteria. Try adjusting your filters.`
                  : `There are no ${actualSpecialization} doctors registered yet.`
                }
              </p>
              {(searchTerm || selectedLocation) && (
                <button
