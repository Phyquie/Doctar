...
export default function NewsPage() {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/news?page=${currentPage}&limit=${itemsPerPage}&search=${searchTerm}`);
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Health News & Updates</h1>
          <p className="text-gray-600">Stay informed with the latest health news and medical updates from our experts</p>
        </div>
        ...
        {!loading && !error && news.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">
              {searchTerm ? 'Try adjusting your search terms' : 'Check back soon for new updates'}
            </p>
          </div>
        )}
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-500 mt-4 pt-4 border-t border-gray-100">
                    ...
                    {newsItem.author && (
                      <div className="flex items-center">
                        ...
                        <span className="truncate">Dr. {newsItem.author.firstName} {newsItem.author.lastName}</span>
                      </div>
                    )}
                  </div>
                </div>
